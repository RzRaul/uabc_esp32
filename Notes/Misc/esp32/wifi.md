Primero se configura el access point
Se configura el servidor http
Se inicializa el servidor http
Se registran los manejadores de URI
Se registras los manejadores de eventos de wifi
Una vez se conecta un dispositivo, el ESP32 busca los headers de la peticion y los imprime
